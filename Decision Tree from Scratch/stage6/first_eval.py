...
features_train_stage6 = train_data[["Pclass", "Sex", "SibSp", "Parch"]]
target_train_stage6 = train_data["Survived"].values
features_test_stage6 = test_data[["Pclass", "Sex", "SibSp", "Parch"]]
target_test_stage6 = test_data["Survived"].values
tree = DecisionTree(min_el=74)
tree.fit(features_train_stage6, target_train_stage6)
